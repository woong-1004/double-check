        ...
        <div className="fixed inset-0 flex items-center justify-center p-4">
          <Dialog.Panel className="mx-auto max-w-2xl rounded bg-white p-6 max-h-[80vh] overflow-y-auto">
            ...
            <div className="prose prose-sm max-w-none text-black">
              <p className="mb-6">
                더블체크(이하 &quot;사이트&quot;)는 『개인정보 보호법』 등 관련
                법령을 준수하며, 이용자의 개인정보를 보호하기 위해 다음과 같은
                개인정보처리방침을 수립·공개합니다. 본 방침은 사이트가 운영하는
                더블체크.한국 웹사이트(이하 &quot;더블체크&quot;)에 적용됩니다.
              </p>

              <h2 className="text-xl font-bold text-black mt-8 mb-4">
                1. 개인정보의 수집 항목 및 수집 방법
              </h2>
              <ul className="list-disc pl-5 mb-6">
                <li>수집 항목: 이메일 주소</li>
                <li>
                  수집 방법: 웹사이트 하단의 뉴스레터 구독 신청 양식을 통한 수집
                </li>
              </ul>
              ...
              <p className="mb-4">
                본 방침은 관련 법령 및 정책 변경 시 사전 공지됩니다.
              </p>
              <ul className="list-disc pl-5 mb-6">
        ...
        <div className="fixed inset-0 flex items-center justify-center p-4">
          <Dialog.Panel className="mx-auto max-w-2xl rounded bg-white p-6 max-h-[80vh] overflow-y-auto">
            ...
            <div className="prose prose-sm max-w-none text-black">
              ...
              <p className="mb-6">
                더블체크(DoubleCheck) 웹사이트(이하 &quot;사이트&quot;)를
                이용함으로써, 귀하는 다음의 약관에 동의하는 것으로 간주됩니다.
              </p>
              ...
              <p className="mb-6">
                이 약관은 더블체크 사이트(https://더블체크.com)가 제공하는 정책
                비교, 언론 콘텐츠 비교 및 뉴스레터 서비스(이하
                &quot;서비스&quot;)의 이용 조건과 운영에 관한 사항을 규정함을
                목적으로 합니다.
              </p>
              ...
              <ol className="list-decimal pl-5 mb-6">
                <li className="mb-2">
                  <strong>정책체크</strong>: 주요 후보자들의 정책을
                  비교·정리하여 사용자에게 제공하는 정보 서비스입니다.
                </li>
                <li className="mb-2">
                  <strong>뉴스체크</strong>: 좌·우 언론 및 방송사의 뉴스
                  콘텐츠를 비교·제공하고, AI 요약 및 팩트체크를 덧붙여
                  제공합니다.
                </li>
                <li>
                  <strong>뉴스레터</strong>: 사용자가 직접 입력한 이메일 주소를
                  수집하여 정기적으로 뉴스 요약 정보를 제공합니다.
                </li>
              </ol>
              ...
              <ol className="list-decimal pl-5 mb-6">
                <li className="mb-2">
                  본 사이트에서 제공하는 콘텐츠(텍스트, 요약, 정리 등)는
                  더블체크 또는 제휴된 제3자의 지적재산권 보호를 받습니다.
                </li>
                <li>
                  사용자는 본 서비스의 정보를 상업적 목적 없이 비영리적 이용에
                  한해 활용할 수 있으며, 출처 표기 없이 무단 복제, 배포, 2차
                  가공하는 행위를 금합니다.
                </li>
              </ol>
              ...
              <ol className="list-decimal pl-5 mb-6">
                <li className="mb-2">
                  본 사이트는 정보 제공을 목적으로 하며, 특정 정당, 후보자,
                  언론사를 지지하거나 비방하지 않습니다.
                </li>
                <li className="mb-2">
                  제공되는 정보의 정확성이나 완전성에 대해서는 보장하지 않으며,
                  이를 근거로 한 판단이나 행동의 책임은 전적으로 이용자에게
                  있습니다.
                </li>
                <li>
                  외부 콘텐츠(언론 기사, 유튜브 영상 등)는 원 저작자에게 권리가
                  있으며, 사이트는 해당 콘텐츠의 소유권을 주장하지 않습니다.
                </li>
              </ol>
              ...
              <ol className="list-decimal pl-5 mb-6">
                <li className="mb-2">
                  사이트는 뉴스레터 발송을 위해 사용자의 이메일 주소만을
                  수집하며, 이 정보는 제3자에게 제공되지 않습니다.
                </li>
                <li>
                  개인정보 수집 및 보호에 관한 자세한 사항은 개인정보처리방침을
                  따릅니다.
                </li>
              </ol>
              ...
              <ol className="list-decimal pl-5 mb-6">
                <li className="mb-2">
                  사이트는 콘텐츠 제공 또는 기술적 사유로 인해 서비스 내용을
                  사전 예고 없이 변경하거나 중단할 수 있습니다.
                </li>
              ...
              <p className="mb-2">
                서비스와 관련된 문의는 아래 연락처를 통해 접수받습니다.
              </p>
              <ul className="list-disc pl-5 mb-6">
                <li>이메일: worldiswoong@gmail.com</li>
                <li>인스타그램 DM: @worldiswoong</li>
